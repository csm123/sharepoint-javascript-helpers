...
SharePoint.Config = {errorAlerts: true};
...
SharePoint.spread = function(callback) {
...
SharePoint.all = function (promises) {
  /* From Axios - https://github.com/mzabriskie/axios/ */
...
SharePoint.Error = function(sender, args) {
  ...
  if (SharePoint.Config.errorAlerts) {
...
SharePoint.GetCurrentUserEmail = function(options) {
  return new Promise(function(resolve, reject) {
    var SPContext = SharePoint.Utils.GetContext((options && options.site) || null);
    var web = SPContext.get_web();
